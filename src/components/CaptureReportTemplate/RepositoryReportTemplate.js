...
const asyncValidate = (values, dispatch) => {
  return dispatch(actionCheckReportId(values.report_id,values.country,'master'))
    .then((action) => {
...
class RepositoryReportTemplate extends Component {
    constructor(props) {
        super(props);
        this.state={
          isSubmitted: false,
...
const VisibleRepositoryReportTemplate = connect(
    mapStateToProps,
    mapDispatchToProps
)(RepositoryReportTemplate);

export default reduxForm({
    form: 'RepositoryTemplate',
    validate,
    asyncValidate,
    asyncBlurFields: ['report_id']
})(VisibleRepositoryReportTemplate);
