            ...
            item.map((item,index)=>{
              return(
                ...
                <tr>
                  ...
                  <td
                    title={item.cell_calc_decsription.substring(0,600)}>
                    <span className="truncate-text">{item.cell_calc_decsription}</span>
                  </td>
                  <td>
                      ...
                      onClick={
                        (event)=>{
                          let calcBusinessRuleFilter = {
                                  id: 'business_rule',
                                  value: item.cell_business_rules.split(',').filter(item => item !== ""),
                                  cell_calc_ref: item.cell_calc_ref
                                }
