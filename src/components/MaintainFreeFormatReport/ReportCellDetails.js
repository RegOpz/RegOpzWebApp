...
class ReportCellDetails extends Component {
  constructor(props){
    ...
    this.state={
      // TODO
      displayCalc: false,
      displayCalcType: "Slide",
      displayAgg: false,
      displayAggType: "Slide",
    }
  ...
  render(){
    const { handleClose, handleBoxSize, handleBringToFront, details, selectedCell } = this.props;
    if(!this.cellRules){
      return(
        <div>
          {
    ...
    return(
          <div className="x_panel">
            <div className="x_title">
              ...
              <ul className="nav navbar-right panel_toolbox">
                <li>
                  <a className="close-link" onClick={()=>{handleClose(details.id)}}><i className="fa fa-close"></i></a>
                </li>
                <li>
                  <a onClick={()=>{
                      let boxSize = {
                    ...
                    }} title={details.isMaximized ? "Restore" : "Maximize"}>
