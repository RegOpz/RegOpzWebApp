...
class RepositoryReportBusinessRules extends Component {
  constructor(props){
    super(props);
    this.state={
      pageSize: 20,
  ...
  renderCalcRules(calcRules){
    if (calcRules.length == 0)
      ...
      let columns = ['sheet_id','cell_id','cell_calc_ref','in_use','cell_business_rules','aggregation_ref','aggregation_func'];
...
export default RepositoryReportBusinessRules;
